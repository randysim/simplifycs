...
export default function Unit() {
    ...
    const renderUnitData = () => {
        ...
        return (
            ...
            <Box>
                <Box sx={{ width: "100%", height: "175px", paddingLeft: "50px", display: "flex", alignItems: "center"}} bgcolor="primary.main">
                    <Typography sx={{ fontSize: "40px"}}>Unit: {unit.name}</Typography>
                </Box>
                <Box sx={{ width: "100%", height: "auto"}}>
                    <Box>
                        <Typography sx={{ fontSize: "20px", paddingLeft: "50px"}}>Lessons:</Typography>
                    </Box>
                    <Box sx={{ width: "100%", display: "flex", justifyContent: "center", flexWrap: "wrap"}}>
                        {unit.lessons.map((l, i) => {
                            return (
                                <Box sx={{ width: "80%", minWidth: "400px", padding: "20px", border: "4px solid white", marginTop: "50px", cursor: "pointer"}} onClick={() => {
